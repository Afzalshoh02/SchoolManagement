...
var Style = /*#__PURE__*/function () {
  ...
  Style_createClass(Style, [{
    ...
    value: function fromNode($node) {
      var properties = ['font-family', 'font-size', 'text-align', 'list.blade.php-style-type', 'line-height'];
    ...
    value: function current(rng) {
      ...
      if (!rng.isOnList()) {
        ...
        var isUnordered = orderedTypes.indexOf(styleInfo['list.blade.php-style-type']) > -1;
  ...
  HelpDialog_createClass(HelpDialog, [{
    ...
    value: function createShortcutList() {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        var $row = external_jQuery_default()('<div><div class="help-list.blade.php-item"></div></div>');
...
var dropdown = renderer.create('<div class="note-dropdown-menu dropdown-menu" role="list.blade.php"></div>', function ($node, options) {
...
var dropdownCheck = renderer.create('<div class="note-dropdown-menu dropdown-menu note-check" role="list.blade.php"></div>', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
