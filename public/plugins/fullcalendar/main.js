    ...
    var SegHierarchy = /** @class */ (function () {
        ...
        SegHierarchy.prototype.findInsertion = function (newEntry) {
            ...
            for (var trackingLevel = 0; trackingLevel < levelCnt; trackingLevel += 1) {
                ...
                (trackingEntry = trackingEntries[lateralIndex]) && // but not past the whole entry list.blade.php
    ...
    */
    ...
    function findNextLevelSegs(hierarchy, subjectLevel, subjectLateral) {
        ...
        for (; level < levelCnt; level += 1) {
            ...
            while ( // loop through entries that horizontally intersect
            (entry = entries[lateralEnd]) && // but not past the whole seg list.blade.php
    ...
    function renderInnerContent(props) {
        return (createElement(Fragment, null,
            props.text && (createElement("a", __assign({ id: props.textId, className: "fc-list.blade.php-day-text" }, props.navLinkAttrs), props.text)),
            props.sideText && ( /* not keyboard tabbable */createElement("a", __assign({ "aria-hidden": true, className: "fc-list.blade.php-day-side-text" }, props.sideNavLinkAttrs), props.sideText))));
    }
    ...
    var ListViewEventRow = /** @class */ (function (_super) {
        ...
        ListViewEventRow.prototype.render = function () {
            ...
            return (createElement(EventRoot, { seg: seg, timeText: "" // BAD. because of all-day content
                ...
                createElement("td", { "aria-hidden": true, className: "fc-list.blade.php-event-graphic" },
                ...
                createElement("td", { ref: innerElRef, headers: eventHeaderId + " " + dateHeaderId, className: "fc-list.blade.php-event-title" }, innerContent))); }));
        };
    ...
    function buildTimeContent(seg, timeFormat, context, timeHeaderId, dateHeaderId) {
        ...
        if (options.displayEventTime !== false) {
            ...
            if (doAllDay) {
                ...
                return (createElement(RenderHook, { hookProps: hookProps, classNames: options.allDayClassNames, content: options.allDayContent, defaultContent: renderAllDayInner, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) { return (createElement("td", { ref: rootElRef, headers: timeHeaderId + " " + dateHeaderId, className: ['fc-list.blade.php-event-time'].concat(classNames).join(' ') }, innerContent)); }));
            }
